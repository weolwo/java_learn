 ...
 */
public abstract class AbstractQueuedSynchronizerSrc
        extends AbstractOwnableSynchronizerSrc
     ...
     */
    protected AbstractQueuedSynchronizerSrc() {
    }
    ...
    public final boolean hasQueuedPredecessors() {
        ...
        Node h = head;
        Node s;
        //h == t 有三种情况，1.队列还未初始化 2.队列中只有一个元素， 3.
        return h != t &&
                //(s = h.next) == null 只有队列中只有一个时
    ...
    public class ConditionObject implements Condition, java.io.Serializable {
         ...
         * @return {@code true} if owned
         */
        final boolean isOwnedBy(AbstractQueuedSynchronizerSrc sync) {
            return sync == AbstractQueuedSynchronizerSrc.this;
        }

        /**
         * Queries whether any threads are waiting on this condition.
         * Implements {@link AbstractQueuedSynchronizerSrc#hasWaiters(ConditionObject)}.
         *
         * @return {@code true} if there are any waiting threads
         ...
         * this condition.
         * Implements {@link AbstractQueuedSynchronizerSrc#getWaitQueueLength(ConditionObject)}.
         *
    ...
    static {
        try {
            stateOffset = unsafe.objectFieldOffset
                    (AbstractQueuedSynchronizerSrc.class.getDeclaredField("state"));
            headOffset = unsafe.objectFieldOffset
                    (AbstractQueuedSynchronizerSrc.class.getDeclaredField("head"));
            tailOffset = unsafe.objectFieldOffset
                    (AbstractQueuedSynchronizerSrc.class.getDeclaredField("tail"));
